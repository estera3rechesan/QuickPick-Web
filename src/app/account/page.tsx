...
export default function AccountPage() {
  ...
  // Refs pentru scroll la secțiuni (corect: HTMLDivElement | null)
  ...
  // Scroll la secțiune (acceptă și null)
      ...
      <div className="flex-1">
        ...
        <div ref={setariRef} className="mt-12">
          ...
          <section className="mb-6">
            <h3 className="font-semibold text-[#353935] mb-2">Editează email</h3>
          ...
          <section className="mb-6">
            <h3 className="font-semibold text-[#353935] mb-2">Schimbă parola</h3>
          ...
          {showDeleteInfo && (
            <div className="mt-4 p-4 bg-[#FFECEC] border border-[#FF8787] rounded">
              ...
              <button
                ...
                className="bg-[#FF8787] text-white px-3 py-1 rounded hover:bg-[#ffb0b0]"
              >
                Închide
              </button>
            </div>
