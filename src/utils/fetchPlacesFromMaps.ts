...
// Funcția principală pentru căutarea locațiilor cu Google Places
export async function fetchPlacesFromMaps(options: FetchPlacesOptions): Promise<PlaceResult[]> {
  ...
  // Pentru fiecare locație găsită, obține detalii suplimentare
  ...
  // Filtrează rezultatele după rating și preț
